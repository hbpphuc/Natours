...
exports.login = catchAsync(async (req, res, next) => {
    ...
    // 3. If everthing ok, sent token to client
...
exports.forgotPassword = catchAsync(async (req, res, next) => {
    ...
    try {
        ...
        const message = `Forgot your password? Please submit a PATCH request with your new password and password confirm to: ${resetURL}.\nIf you didn't forget your password, please ignore this email`;
        await sendEmail({
            email: req.body.email,
...
exports.updatePassword = catchAsync(async (req, res, next) => {
    ...
    // 2. Check if password is incorrect
    if (!correct) {
    ...
    createSendToken(currUser, 201, req, res);
});
